...
SKELETON_DEBIAN_DEPENDENCIES = host-debootstrap host-fakeroot host-fakechroot
...
SKELETON_DEBIAN_DEBOOTSTRAP_OPTS += --variant fakechroot
...
define SKELETON_DEBIAN_BUILD_CMDS
	mkdir -p $(@D)/rootfs
	PATH=$(BR_PATH) $(HOST_DIR)/bin/fakechroot -- $(HOST_DIR)/bin/fakeroot -- $(HOST_DIR)/bin/debootstrap $(SKELETON_DEBIAN_DEBOOTSTRAP_OPTS) $(SKELETON_DEBIAN_DEBOOTSTRAP_SUITE) $(@D)/rootfs $(SKELETON_DEBIAN_DEBOOTSTRAP_MIRROR)
endef
