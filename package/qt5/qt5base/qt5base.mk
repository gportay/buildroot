...
define QT5BASE_CONFIGURE_CMDS
	...
	sed -e 's/@EGLFS_DEVICE@/$(QT5BASE_EGLFS_DEVICE)/g' \
	    ...
	    -e 's,@QMAKE_LIBS_EGL@,$(QT5BASE_QMAKE_LIBS_EGL),g' \
	    -e 's,@QMAKE_LIBS_OPENGL_ES2@,$(QT5BASE_QMAKE_LIBS_OPENGL_ES2),g' \
