...
QT5VIRTUALKEYBOARD_QMAKEFLAGS += CONFIG+=t9write
else
QT5VIRTUALKEYBOARD_3RDPARTY_PARTS = YES
...
QT5VIRTUALKEYBOARD_QMAKEFLAGS += CONFIG+=hunspell
else
ifeq ($(BR2_PACKAGE_HUNSPELL),y)
QT5VIRTUALKEYBOARD_QMAKEFLAGS += CONFIG+=disable-hunspell
endif
endif

ifeq ($(BR2_PACKAGE_QT5VIRTUALKEYBOARD_RETRO_STYLE),y)
QT5VIRTUALKEYBOARD_QMAKEFLAGS += CONFIG+=retro-style
endif
