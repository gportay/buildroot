...
ifeq ($(BR2_PACKAGE_QT5_VERSION_LATEST),y)
QT5WEBKIT_DEPENDENCIES += gstreamer1 gst1-plugins-base gst1-plugins-bad jpeg libxslt qt5location qt5sensors qt5webchannel

QT5WEBKIT_CONF_OPTS += -DPORT=Qt -DUSE_LIBHYPHEN=OFF
