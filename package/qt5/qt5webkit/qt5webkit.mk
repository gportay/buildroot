...
ifeq ($(BR2_PACKAGE_QT5_VERSION_LATEST),y)
QT5WEBKIT_DEPENDENCIES += gstreamer1 gst1-plugins-good jpeg libpng libxslt \
	qt5declarative qt5location qt5sensors qt5webchannel

QT5WEBKIT_CONF_OPTS += -DPORT=Qt -DUSE_SYSTEM_MALLOC=ON -DUSE_LIBHYPHEN=OFF
